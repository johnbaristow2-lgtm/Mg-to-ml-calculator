...
const HowMuchIs20mgInSyringe: React.FC = () => {
    return (
        ...
        >
            ...
            <h3>Understanding Concentration: The Key to Safe Dosing</h3>
            <p>
            ...
            <h3>The Formula for Dosage Calculation</h3>
            <p>
            ...
            <h4>Example 2: Higher Concentration (e.g., 25 mg/mL)</h4>
            <p>
            ...
            <h3>Always Double-Check and Seek Professional Advice</h3>
            <p>
